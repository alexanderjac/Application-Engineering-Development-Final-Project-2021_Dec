...
public class HASPatientRequestsJPanel extends javax.swing.JPanel {
    ...
    HASPatientRequestsJPanel(JPanel userProcessContainer, UserAccount userAccount, ReceptionistOrganisation organization, Enterprise enterprise, EcoSystem eco) {
    ...
    private void initComponents() {
        ...
        cmbNurseList.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmbNurseListActionPerformed(evt);
            }
        });
    ...
    private void btnAssignToNurseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAssignToNurseActionPerformed
        ...
        if (nurseUserAccount.getRole() instanceof NurseRole) {
            ...
            ((UserAccount) nurseUserAccount).getWorkQueue().getListOfWorkRequests().add(request);
        }
        populateNurseListCmb();
        populateTable();
...
//        }
    ...
    private void cmbNurseListActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbNurseListActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cmbNurseListActionPerformed
