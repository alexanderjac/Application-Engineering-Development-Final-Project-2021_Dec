...
public class FundTransferRequestJpanel extends javax.swing.JPanel {
    ...
    public FundTransferRequestJpanel(JPanel userProcessContainer, UserAccount account, FundRaiserOrganisation organization,  FundEnterprise enterprise, Network network, EcoSystem business) {
        initComponents();
    ...
    private void btnApproveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnApproveActionPerformed
        ...
        if(request.getTypeOfRequest().equalsIgnoreCase("RaiseFee")){
            ...
            int funds = request.getRequest().getPatientFee();
            // int funds2 = Integer.parseInt(tblHospitalRequest.getValueAt(row, 1).toString());
            for (Enterprise e : ed.getListOfEnterprises()) {
             ...
             enterprise.setFundsUsed(request.getPatientFee());
            WorkRequest r = request.getRequest();
