...
public class DoctorMainWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public DoctorMainWorkAreaJPanel(JPanel userProcessContainer, UserAccount userAccount, DoctorOrganisation doctorOrganisation, Enterprise enterprise, EcoSystem business) {
