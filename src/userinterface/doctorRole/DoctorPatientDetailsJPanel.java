...
public class DoctorPatientDetailsJPanel extends javax.swing.JPanel {
    ...
    DoctorPatientDetailsJPanel(JPanel userProcessContainer, UserAccount userAccount, WorkRequest request, Enterprise enterprise, DoctorOrganisation doctorOrganisation, JSplitPane jSplitPane2) {
    ...
    private void populateData() {
        ...
        bldGrp.setText(request.getPatientBloodGroup());
        bldPres.setText(request.getPatientBloodPressure());
        bodyTemp.setText(Float.toString(request.getPatientBodyTemperature()));
        gluLvl.setText(Float.toString(request.getPatientGlucoseLevel()));
        patientSym.setText(request.getPatientSymptoms());
        diagnosis.setText(request.getPatientDiagnosis());
...
//            layout.previous(userProcessContainer);
            DoctorAreaPatientListJPanel dapljp = new DoctorAreaPatientListJPanel(userProcessContainer, userAccount, doctorOrganisation, enterprise, EcoSystem.business, jSplitPane2);
