...
//        populateCombo();
    ...
    private void initComponents() {
        ...
        btnAlert.setBackground(new java.awt.Color(99, 200, 242));
...
//            userAccount.getWorkQueue().getWorkRequestList().add(request);
    ...
    private void btnAlertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlertActionPerformed
        ...
        try{
            ...
            request.setPatientFee(Integer.parseInt(input));
        } catch(Exception e){
...
//if(cmbRequestType.getSelectedItem().toString().equalsIgnoreCase("Awaiting admin approval")) {
        for (WorkRequest req : userAccount.getWorkQueue().getListOfWorkRequests()) {
            ...
            System.out.println("check3 "+userAccount.getUsername());
            if (req.getTypeOfRequest().equals("AssignHospital") || (req.getTypeOfRequest().equals("Fund Patient"))) {
