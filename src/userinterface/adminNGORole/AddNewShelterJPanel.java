...
public class AddNewShelterJPanel extends javax.swing.JPanel {
    ...
    Network network;
    EcoSystem system;
    NGOOrganisation organisation;
    public AddNewShelterJPanel(JPanel userProcessContainer, UserAccount account, NGOOrganisation organisation, Enterprise enterprise, Network network, EcoSystem business) {
    ...
    private void addJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addJButtonActionPerformed
      ...
      Organization org =  enterprise.getOrganizationDirectory().createAndAddOrganization(type);
      Employee emp = org.getEmployeeDirectory().createAndAddEmployee(txtName.getText());
      ...
      if(org.getOrganizationType().equalsIgnoreCase("OldAgeHome Organization")){
          UserAccount user = org.getUserAccountDirectory().createAndAddUserAccount(txtUser.getText(), txtPass.getText(), emp, new OldAgeHomeRole());
          ...
          UserAccount user = org.getUserAccountDirectory().createAndAddUserAccount(txtUser.getText(), txtPass.getText(), emp, new AdultCareRole());
          JOptionPane.showMessageDialog(null, "An Organization and user has beesn added successfully");
      }else if(org.getOrganizationType().equalsIgnoreCase("ChildCare Organization")){
          UserAccount user = org.getUserAccountDirectory().createAndAddUserAccount(txtUser.getText(), txtPass.getText(), emp, new ChildCareRole());
          JOptionPane.showMessageDialog(null, "An Organization and user has beesn added successfully");
      }
