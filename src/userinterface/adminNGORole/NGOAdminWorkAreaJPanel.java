...
public class NGOAdminWorkAreaJPanel extends javax.swing.JPanel {
    ...
    Network network;
    EcoSystem system;
    NGOOrganisation organization;
    public NGOAdminWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, NGOOrganisation organization, Enterprise enterprise, Network network, EcoSystem business) {
