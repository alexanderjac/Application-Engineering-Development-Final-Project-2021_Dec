...
//    public LabAssistantWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, LabOrganization labOrganization, EcoSystem business, Enterprise enterprise) {
...
//    }
     ...
     */
    public LabAssistantWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, LabOrganisation organization, EcoSystem business, Enterprise enterprise, JSplitPane jSplitPane2) {
        initComponents();
    ...
    public void populateTable() {
        ...
        for (WorkRequest request : labOrganization.getWorkQueue().getListOfWorkRequests()) {
