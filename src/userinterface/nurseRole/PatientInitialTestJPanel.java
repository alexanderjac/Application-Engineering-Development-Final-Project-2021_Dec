...
public class PatientInitialTestJPanel extends javax.swing.JPanel {
    ...
    PatientInitialTestJPanel(JPanel userProcessContainer, UserAccount userAccount, NurseOrganisation nurseOrganisation, EcoSystem business, Enterprise enter, Network network, WorkRequest request, JSplitPane jSplitPane2) {
    ...
    private void initComponents() {
        ...
        patientfee.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        ...
        bodyTemp.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        ...
        bldGrp.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        ...
        bldPres.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        ...
        gluLvl.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        ...
        patientSym.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        ...
        if (bldGrp.getText().isEmpty() || bldPres.getText().isEmpty() || bodyTemp.getText().isEmpty() || gluLvl.getText().isEmpty() || patientSym.getText().isEmpty() || diagnosis.getText().isEmpty() || priority.getText().isEmpty() || patientfee.getText().isEmpty()) {
            ...
            if (check == 1 && checkint == 1 && checkBlood != 0) {
                ...
                if ((request.getTypeOfRequest().equals("InitialCheckupNurseAssigned"))) {
                    ...
                    request.setPatientLastLame(lName.getText());
                    request.setAgeOfPerson(Integer.parseInt(age.getText()));
                    request.setPatientHeight(Integer.parseInt(height.getText()));
                    request.setPatientWeight(Integer.parseInt(weight.getText()));
                    request.setPatientGender(gender.getText());
                    request.setPatientBloodGroup(bldGrp.getText());
                    request.setPatientBloodPressure(bldPres.getText());
                    request.setPatientBodyTemperature(Float.parseFloat(bodyTemp.getText()));
                    request.setPatientGlucoseLevel(Float.parseFloat(gluLvl.getText()));
                    request.setPatientSymptoms(patientSym.getText());
                    request.setPatientDiagnosis(diagnosis.getText());
                    request.setPatientPriority(priority.getText());
                    request.setReceiver(userAccount);
                    request.setPatientFee(Integer.parseInt(patientfee.getText()));
...
//                        }
//                    }
                    PatientListInitialTestReqJPanel pitjp = new PatientListInitialTestReqJPanel(userProcessContainer, userAccount, nurseOrganisation, enter, network, business, jSplitPane2);
    ...
    private void populatePatientData() {
        ...
        lName.setText(request.getPatientLastLame());
        age.setText(Integer.toString(request.getAgeOfPerson()));
        height.setText(Integer.toString(request.getPatientHeight()));
        weight.setText(Integer.toString(request.getPatientWeight()));
        gender.setText(request.getPatientGender());
...
//        imagePlacer.setIcon(pic1);
                ...
                if(request.getPatientProfileImage() == null)
            request.setPatientProfileImage("/userProfilePictures/default_profile_picture.jpg");
    ...
    private void setProfilePicture(WorkRequest request) {
        ...
        try {
            img = ImageIO.read(new File("./src" + request.getPatientProfileImage()));
        } catch (IOException e) {
            e.printStackTrace();
        }
