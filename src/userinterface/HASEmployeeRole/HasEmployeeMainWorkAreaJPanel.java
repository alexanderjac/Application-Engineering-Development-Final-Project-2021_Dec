...
public class HasEmployeeMainWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public HasEmployeeMainWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, HasHealthcareRepresentativeOrganisation organization, Enterprise enterprise, EcoSystem business) {
    ...
    private void manageOrganizationJButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_manageOrganizationJButton1ActionPerformed
        ...
        HASEmployeeWorkRequestsJPanel hasWorkRquestsWorkPanel = new HASEmployeeWorkRequestsJPanel(userProcessContainer, account, (HasHealthcareRepresentativeOrganisation) organization, enterprise, business);
    ...
    private void manageOrganizationJButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_manageOrganizationJButton2ActionPerformed
        ...
        HASEmployeeWorkStatusJPanel workStatusPanel = new HASEmployeeWorkStatusJPanel(userProcessContainer, account, (HasHealthcareRepresentativeOrganisation) organization, enterprise, business);
...
//               layout.next(userProcessContainer);
//
//        HASStatisticsJPanel hsjp = new HASStatisticsJPanel(userProcessContainer, account, enterprise, network, business);
